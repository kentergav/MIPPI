...
#     dense2 = layers.Dense(4, activation='softmax', kernel_initializer='he_uniform')
    ...
    mut0 = layers.Conv1D(64, 3, padding='same', kernel_initializer='he_uniform')(mut0)
    mut1 = layers.Conv1D(64, 3, padding='same', kernel_initializer='he_uniform')(mut1)
    par0 = layers.Conv1D(32, 3, padding='same', kernel_initializer='he_uniform')(par0)
    par0 = layers.Conv1D(32, 5, padding='same', kernel_initializer='he_uniform')(par0)
    par0 = layers.Conv1D(64, 5, padding='same', kernel_initializer='he_uniform')(par0)
